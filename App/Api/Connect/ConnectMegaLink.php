...
class ConnectMegaLink
{
    /**
     * Constantes com insformações de acesso ao banco da Slave da elite Soft.
     */
     private const HOSTISP = "191.242.216.110";
     private const USERDBISP = "root";
     private const DBNAMEISP = "sac_megalink";
     private const PASSWORD = "mega@link";
    ...
    public static function getInstanceISP(): PDO
    {
        if (empty(self::$instanceISP)){
            try {
                ...
                die("<h1>Erro ao conectar $exception </h1>");
            }
        }
